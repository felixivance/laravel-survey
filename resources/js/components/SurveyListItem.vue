    ...
    <div class="flex justify-between items-center mt-3">
      ...
      <div class="flex items-center">
        ...
        border border-transparent text-sm text-indigo-500 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l2.4 2M7 9h10l2.4 2M7 5h10l2.4 2M7 13A2 2 0 0 0 9 15H7a2 2 0 0 0 0-2z" />
          </svg>
          <p>View</p>
        ...
        <button v-if="survey.id" type="button" @click="deleteSurvey(survey)" class="h-8 w-8 flex items-center justify-center rounded-full
          ...
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
